...
if curl -s --head curl https://server-5.itrocket.net/testnet/fiamma/fiamma_2024-08-04_421972_snap.tar.lz4 | head -n 1 | grep "200" > /dev/null; then
  curl https://server-5.itrocket.net/testnet/fiamma/fiamma_2024-08-04_421972_snap.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.fiamma
    else
