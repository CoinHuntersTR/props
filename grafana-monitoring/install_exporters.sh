...
read -p "Enter bond_denom value, for example, udym for Dymension: " BOND_DENOM
read -p "Enter bench_prefix value, for example, dymension for Dymension: " BENCH_PREFIX
...
COSMOS_EXPORTER_VERSION="v0.3.0" # Replace with the latest version
...
NODE_EXPORTER_VERSION="v1.8.2" # Replace with the latest version
